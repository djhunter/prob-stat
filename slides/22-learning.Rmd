...
>- Linear regression: $\hat{f}(x) = \beta_0 + \hat\beta_1x_1 + \hat\beta_2x_2 + \cdots + \hat\beta_px_p$. Parameters are the model coefficients: $\theta = (\beta_0, \beta_1, \beta_2, \ldots, \beta_p)$.
